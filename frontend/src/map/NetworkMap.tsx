...
const layerGroups: Record<keyof LayerState, string[]> = {
  ...
  pipes: ["service-pipes", "main-pipes"],
  ...
  useEffect(() => {
    ...
    map.on("load", () => {
      try {
        ...
        map.addLayer({ id: "service-pipes", type: "line", source: "pipes", filter: ["!", ["in", ["get", "pipe_type"], ["literal", ["main", "main_pipe", "distribution", "hovedledning"]]]], paint: { "line-color": "#54d5c6", "line-width": ["interpolate", ["linear"], ["zoom"], 10, 1.4, 17, 3], "line-dasharray": [2, 1.5] } });
        map.addLayer({ id: "main-pipes", type: "line", source: "pipes", filter: ["in", ["get", "pipe_type"], ["literal", ["main", "main_pipe", "distribution", "hovedledning"]]], paint: { "line-color": "#1d8cff", "line-width": ["interpolate", ["linear"], ["zoom"], 10, 2.4, 17, 5] } });
