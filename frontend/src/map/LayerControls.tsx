...
const layers: { id: MapLayerId; label: string; detail: string }[] = [
  ...
  { id: "mainValves", label: "Hovedhaner", detail: "Haner på hovedforsyningsledninger" },
  { id: "distributionValves", label: "Fordelingshaner", detail: "Haner på fordelingsledninger" },
  { id: "serviceValves", label: "Stikhaner", detail: "Haner på stikledninger" },
  { id: "uncategorizedValves", label: "Ikke kategoriserede haner", detail: "Skal klassificeres i QGIS" },
